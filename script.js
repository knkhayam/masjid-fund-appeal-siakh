...
fetch('work-phases.json?v=49')
  ...
  .then(data => {
    ...
    const sortedPhases = data.phases.sort((a, b) => a.order - b.order);
      ...
      fetch('contributions.json?v=49').then(res => res.json()).then(contributions => {
          ...
          messageCard.innerHTML = `
            ...
            <div class="message-content">
              <div class="urdu-message">
                ...
                <p>الحمدللہ! اللہ تعالیٰ کے فضل و کرم سے مسجد شریف کا پہلا فیز (بنیاد) اور دوسرا فیز (پانی کا نظام، دیواریں اور چھت) مکمل ہو چکا ہے۔ پہلے فیز پر تقریباً <strong>11,80,000 گیارہ لاکھ اسی ہزار روپے</strong> اور دوسرے فیز پر تقریباً <strong>28,14,210 اٹھائیس لاکھ چودہ ہزار دو سو دس روپے</strong> کی لاگت آئی ہے۔</p>
